function CBall(iXPos, iYPos, oSprite, oPhysics, oParentContainer) {
    ...
    this._init = function (iXPos, iYPos, oSprite) {
        ...
        var oData = {
            ...
            frames: {width: oSprite.width / 7, height: oSprite.height / 3, regX: (oSprite.width / 2) / 7, regY: (oSprite.height / 3) / 2}
        };
        var oSpriteSheet = new createjs.SpriteSheet(oData);
        _oBall = createSprite(oSpriteSheet, 0, (oSprite.width / 2) / 7, (oSprite.height / 3) / 2, oSprite.width / 7, oSprite.height / 3);
        _oBall.stop();
        this.scale(_fScale);
